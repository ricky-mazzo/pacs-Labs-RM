...
main(int argc, char **argv)
{
  // Vector problem.
  {
...

    {
      ...
      auto jac_full = make_jacobian</*JacobianType::Full*/FullJacobian>(jacobian_fun);
      //std::unique_ptr <JacobianBase> jac_full = 
      //      std::make_unique <FullJacobian> (jacobian_fun);
      
      Newton newton(system, std::move(jac_full)); //type && const type &
...

    {
      ...
      auto jac_discrete = make_jacobian</*JacobianType::Discrete*/DiscreteJacobian>(system, h);
      
      //std::unique_ptr <JacobianBase> jac_discrete = 
      //      std::make_unique <DiscreteJacobian> (system, h);
